...
public class AsyncMain {
    ...
    public static void main(String[] args) {
        ...
        logger.info("OpenSSL support {}", openSslSupport ? "enabled" : "disabled");
        logger.info("OpenSSL version: {}", OpenSsl.versionString());
    ...
    private void getStartedDemo() throws Exception {
        ...
        try {
            client = new CosmosClientBuilder()
                ...
                .directMode(
                    ...
                    .setIdleEndpointTimeout(Duration.ofSeconds(30)))
                .buildAsyncClient();
        } catch (Throwable e) {
            logger.error("Cosmos client creation failed", e);
            throw e;
        }
        ...
        // Create a cached thread pool (threads are created as needed and reused)
        ...
        // Important: Shut down the executor service when no more tasks are expected
        // This allows the program to exit gracefully once all tasks are complete
...
class MyFireAndForgetTask implements Runnable {
    private CosmosAsyncClient client;
    private CosmosAsyncDatabase database;
    private CosmosAsyncContainer container;
    protected static Logger logger = LoggerFactory.getLogger(MyFireAndForgetTask.class.getSimpleName());
    
    public MyFireAndForgetTask(CosmosAsyncClient client, CosmosAsyncDatabase database, CosmosAsyncContainer container) {
        this.client = client;
