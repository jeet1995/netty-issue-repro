...
public class Families {
    ...
    public static Family getAndersenFamilyItem() {
        ...
        andersenFamily.setId("Andersen-" + UUID.randomUUID().toString());
    ...
    public static Family getWakefieldFamilyItem() {
        ...
        wakefieldFamily.setId("Wakefield-" + UUID.randomUUID().toString());
    ...
    public static Family getJohnsonFamilyItem() {
        Family andersenFamily = new Family();
        andersenFamily.setId("Johnson-" + UUID.randomUUID().toString());
    ...
    public static Family getSmithFamilyItem() {
        ...
        smithFamily.setId("Smith-" + UUID.randomUUID().toString());
